...
# Description: This script exports the inpatient, ambulance, and outpatient claims each year. Mileage information will be
...
# Loop function to loop over the years defined above
for y in years:
...
# Loop function to loop over years defined above
for y in years:

...
use death_ind_discharge AGE year niss_6_to_5 EL_RACE_ETHNCY_CD EL_SEX_CD STATE_CD using ffs_from_icdpicr_w_niss_six_to_five.dta, clear
...
margins niss_bands, noesample saving(predicted_death_medicaid_ffs_logit_model, replace)

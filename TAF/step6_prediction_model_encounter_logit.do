...
use death_ind_discharge AGE niss_6_to_5 RACE_ETHNCTY_CD SEX_CD STATE_CD using taf_mc_from_icdpicr_w_niss_six_to_five.dta, clear
...
margins niss_bands, noesample saving(taf_predicted_death_medicaid_mc_logit_model, replace)

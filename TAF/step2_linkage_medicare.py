...
# Define years (only need 2016 for now)
years=[2016]
...
# and the following day first then repeat the process with OP. We will be sure to eliminate individuals who were       #
# transported out of state before calculating the proportion matched.                                                  #
########################################################################################################################

#_______________Matched with IP same day, plus one, plus two________________#

# Specify Years (only need 2016 for now)
years=[2016]
...
for y in years:
    ...
    # Read in IP claims (ip create from another project already)
